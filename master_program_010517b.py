...
Pulse_R=Config.getint("settings", "Pulse_R")
Pulse_G=Config.getint("settings", "Pulse_G")
Pulse_B=Config.getint("settings", "Pulse_B")
Pulse_W=Config.getint("settings", "Pulse_W")
